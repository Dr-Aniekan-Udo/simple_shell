...
/**
 * cd_dot - c function to initiate changes to the parent directory
 *
...
/**
 * cd_to - a C function to initiate changes to a directory given
 * by the user
 *
...
/**
 * cd_previous - a C function to initiate changes to the previous directory
 *
 * @datash: data relevant (environ)
 * Return: no return
 */
...
/**
 * cd_to_home - a C function to initiate changes to home directory
 *
 * @datash: data relevant (environ)
 * Return: no return
 */
